...
.DESCRIPTION
    Implements most of the stuff I'd like to see to from a PowerShell syntax highlighter in
    an editor, CLI, and at runtime.

    I haven't found VS Code themes that do a great job differentiating PS output streams,
    generating legible progress bars, and emphasizing elements I typically care about
    inside script logic, so I wrote this to see that all at a glance.
...
process { 
    ...
    Add-TimeStamp "001 - Testing output streams. Here's (forced) verbose." | Write-Verbose -Verbose
    Add-TimeStamp "002 - This is standard output." | Write-Output
    Add-TimeStamp "003 - Here's a warning!"  | Write-Warning
    Add-TimeStamp "004 - HERE'S AN ERROR!" | Write-Error
    Add-TimeStamp "005 - Script finished." | Write-Verbose
}
